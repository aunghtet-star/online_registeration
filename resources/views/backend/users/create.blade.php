        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                <div class=" mb-3 flex justify-between">
                    <h1 class="md:text-3xl font-semibold dark:text-gray-200 ">User Create Page</h1>
                    <div></div>
                ...
                <form action="{{route('user.store')}}" class="relative bg-white rounded-lg shadow dark:bg-gray-700" method="post"  id="admins-update">
                    @csrf
                    <!-- Modal body -->

            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                <section class="text-gray-400 bg-gray-900 body-font">
                    <div class="container px-5 py-24 mx-auto">
                        ...
                        <div class="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
                            ...
                            <div class="p-2 sm:w-1/2 w-full">
                                <div class="bg-gray-800 rounded flex p-4 h-full items-center">
                                    ...
                                    <span class="title-font font-medium text-white">သင်တန်းနှစ် </span>
                                </div>
                            </div>
                            ...
                            <div class="p-2 sm:w-1/2 w-full">
                                <div class="bg-gray-800 rounded flex p-4 h-full items-center">
                                    ...
                                    <span class="title-font font-medium text-white capitalize">{{$user_detail->course_year}}</span>
                                </div>
                            </div>
                            ...
                            <div class="p-2 sm:w-1/2 w-full">
                                <div class="bg-gray-800 rounded flex p-4 h-full items-center">
                                    ...
                                    <span class="title-font font-medium text-white">သင်တန်းအမည် </span>
                                </div>
                            </div>
                            ...
                            <div class="p-2 sm:w-1/2 w-full">
                                <div class="bg-gray-800 rounded flex p-4 h-full items-center">
                                    ...
                                    <span class="title-font font-medium text-white uppercase">{{$user_detail->course_name}}</span>
                                </div>
                            </div>
                            ...
                            <div class="p-2 sm:w-1/2 w-full">
                                <div class="bg-gray-800 rounded flex p-4 h-full items-center">
                                    ...
                                    <span class="title-font font-medium text-white">ယခုနှစ်ခုံအမှတ် </span>
                                </div>
                            </div>
                            ...
                            <div class="p-2 sm:w-1/2 w-full">
                                <div class="bg-gray-800 rounded flex p-4 h-full items-center">
                                    ...
                                    <span class="title-font font-medium text-white">{{$user_detail->this_year_roll_no}}</span>
                                </div>
                            </div>
                            ...
                            <div class="p-2 sm:w-1/2 w-full">
                                <div class="bg-gray-800 rounded flex p-4 h-full items-center">
                                    ...
                                    <span class="title-font font-medium text-white">ယခင်နှစ်ခုံအမှတ်  </span>
                                </div>
                            </div>
                            ...
                            <div class="p-2 sm:w-1/2 w-full">
                                <div class="bg-gray-800 rounded flex p-4 h-full items-center">
                                    ...
                                    <span class="title-font font-medium text-white">{{$user_detail->last_year_roll_no}}</span>
                                </div>
                            </div>
                            <div class="p-2 sm:w-1/2 w-full">
                                <div class="bg-gray-800 rounded flex p-4 h-full items-center">
                        ...
                        <form action="{{ url('admin/inbox_sec_to_final_year/archive/'.$user_detail->id) }}" method="post">
                            @csrf
                        ...
                        <form action="{{ url('admin/inbox_sec_to_final_year/delete/'.$user_detail->id) }}" method="post">
                            @csrf
